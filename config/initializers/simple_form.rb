...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_boolean, tag: 'div', class: 'form-input' do |b|
    b.use :html5
    b.optional :readonly

    b.wrapper tag: 'div', class: 'checkbox' do |ba|
      ba.use :label_input, error_class: 'is-invalid'
    end
  ...
  # TODO: this is from the Bootstrap 4 config. should we keep?
  config.wrappers :multi_select, tag: 'div', class: 'form-input' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: 'form-label'
